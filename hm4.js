...
*/
let random = Math.floor(Math.random() * (21 - 1)) + 0;
// console.log(random)
...
//  console.log(splitMe("ciao sono Giulio"))
...
*/
const deleteOne = function (stri, bool) {
  if (bool === true) {
    result = stri.substring(1);
  } else {
    result = stri.substring(0, stri.length - 1);
  }
  return result;
};
// console.log(deleteOne("mammamia",true))
...
// console.log(onlyLetters( "siamo nel 2021"))
...
//const howManyDays = function(dt1){
//    dt2 = new Date()
//   return Math.floor((Date.UTC(dt2.getFullYear(), dt2.getMonth(), dt2.getDate()) - Date.UTC(dt1.getFullYear(), dt1.getMonth(), dt1.getDate()) ) /(1000 * 60 * 60 * 24))
//}
//console.log(howManyDays(new Date("04/02/2020"))
